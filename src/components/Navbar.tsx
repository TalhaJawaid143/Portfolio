...
const inActiveStyle = "text-white/50 hover:bg-white/40 hover: divide-gray-500/10";
    ...
    <div className="mx-auto max-w-[1440px]">
      ...
      <header className="fixed inset-x-0 top-0 z-50">
        ...
        >
          ...
          <div className="flex items-center lg:order-2 lg:pl-[60px] ml-10">
            {" "}
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 hidden gap-3 rounded-full  bg-gradient-to-r 
              from-gray-400 to-purple-700 bg-clip-text text-transparent text-white lg:flex lg:items-center lg:gap-x-8 lg:order-1">
            {" "}
